<?php if (empty($detail)) redirect("services") ?>
<main id="main" class="">
                    ...
                    <div class="article-inner has-shadow box-shadow-1 box-shadow-2-hover">
                        <header class="entry-header">
                            ...
                            <div class="entry-image relative">
                                <img width="779" height="585" src="<?= base_url("uploads/images/") . $detail->image ?>" class="attachment-large size-large wp-post-image" alt="services image" sizes="(max-width: 779px) 100vw, 779px" />

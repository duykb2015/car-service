! function(a) {
    "use strict";
    var d = {
        init: function() { a(document.body).on("keyup change", "form.register #reg_password, form.checkout #account_password, form.edit-account #password_1, form.lost_reset_password #password_1", this.strengthMeter), a("form.checkout #createaccount").change() },
        ...
        includeMeter: function(s, r) { var e = s.find(".woocommerce-password-strength"); "" === r.val() ? (e.hide(), a(document.body).trigger("wc-password-strength-hide")) : 0 === e.length ? (r.after('<div class="woocommerce-password-strength" aria-live="polite"></div>'), a(document.body).trigger("wc-password-strength-added")) : (e.show(), a(document.body).trigger("wc-password-strength-show")) },
